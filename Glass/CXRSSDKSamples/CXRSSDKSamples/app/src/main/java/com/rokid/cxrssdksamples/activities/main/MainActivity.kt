    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CXRSSDKSamplesTheme(darkTheme = true) {
                MainScreen(toSelfCmd = {
                    viewModel.toUsage(this@MainActivity, UsageType.SELF_CMD)
                }, toKeys = {
...
@Composable
fun MainScreen(toSelfCmd: () -> Unit, toKeys: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        MyButton(text = "Self CMD", onClick = toSelfCmd)
